...
// Mumbai Polygon
var SmartContractAddress = "0x358766B69BcF8Dbc1A63441B184149093939ab96"; 
var SmartContractABI = chessAbi.abi; 
var address = "0x87adCF34C10db3BC6a09E1CdE14500fc7E1694Fc";
var privatekey = process.env.PRIVATE_MUMBAI_KEY;
...
const sendData = async ({winner, bet}) => {
  try {
    ...
    var receipt = await myContract.methods.payment(winner, Web3.utils.toWei(String(bet), 'ether')).send({ from: address, gasPrice: 54000000000});
...
// sendData({winner: "0x41bEb715fe306D589dA4998ddE2bE0DA23d86982", bet: 0.000001});
// app.listen(port);
